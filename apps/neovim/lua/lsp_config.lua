...
vim.api.nvim_set_keymap('n', '[d', '<cmd>lua vim.diagnostic.goto_prev({ popup_opts = {border = "rounded"}})<CR>', opts)
vim.api.nvim_set_keymap('n', ']d', '<cmd>lua vim.diagnostic.goto_next({ popup_opts = {border = "rounded"}})<CR>', opts)
...
local servers = { 'pylsp', 'rust_analyzer', 'tsserver', 'clangd', 'texlab' }
